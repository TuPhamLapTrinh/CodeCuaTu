...
class App(tk.Tk):
    def __init__(self, converter):
        ...
        #Label
        self.intro_label = Label(self, text = 'Chào mừng đến với bảng đổi tiền tệ', fg = 'red', relief=tk.RAISED, borderwidth=3)
        ...
        #placing
        self.from_currency_dropdown.place(x = 30, y = 120) # check
        self.amount_field.place(x = 36, y = 150)
        self.to_currency_dropdown.place(x = 340, y = 120)
        self.converted_amount_field_label.place(x = 346, y = 150)

        #Convert button1 button2 button 3
